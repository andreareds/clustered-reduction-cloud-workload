...
class MultiDatasetInterface(DatasetInterface):
    def __init__(self, filenames=[], input_window=10, output_window=1, horizon=0, training_features=[], target_name=[],
                 train_split_factor=0.8):
        """
        Constructor of the DatasetInterface class
        :param filenames: list: paths of the datasets in .csv format. Default = []
    ...
    def data_save(self, name):
        ...
        :return: None
        """
        super(MultiDatasetInterface, self).data_save()
    ...
    def data_load(self, name):
        ...
        :return: None
        """
        return super(MultiDatasetInterface, self).data_load()
    ...
    def data_summary(self):
        ...
        :return: None
        """
        return super(MultiDatasetInterface, self).data_summary()
    ...
    def dataset_creation(self):
        ...
        for f in self.data_file:
            ...
            self.X_array.append(self.X_array_tmp)
            self.y_array.append(self.y_array_tmp)
    ...
    def dataset_normalization(self, methods=["minmax"], scale_range=(0, 1)):
        ...
        :return: None
        """
        super(MultiDatasetInterface, self).dataset_normalization(methods, scale_range)
    ...
    def windowed_dataset(self, dataset):
        ...
        """
        return super(MultiDatasetInterface, self).windowed_dataset(dataset)
